...
请提供：
- 市场价格区间（低端、中端、高端）
- 主要竞品（3-5个），每个竞品包含1688和淘宝的搜索链接
- 定价建议
- 市场趋势

**重要**：必须为每个竞品生成1688和淘宝的搜索链接！

以JSON格式返回：
{
  "marketResearch": {
    "searchKeyword": "用于1688搜索的关键字（产品名称+核心规格）",
    ...
    "competitors": [
      {
        ...
        "features": ["特性1", "特性2"],
        "marketShare": "市场份额",
        "1688Url": "https://s.1688.com/youyuan/index.htm?tab=searchHead&searchword=竞品名称（URL编码）",
        "taobaoUrl": "https://s.taobao.com/search?q=竞品名称（URL编码）"
      }
    ],
    "pricingAdvice": "定价建议",
    "marketTrends": "市场趋势"
...
**链接生成规则**：
- 1688Url: https://s.1688.com/youyuan/index.htm?tab=imageSearch&searchword={产品名称}&beginPage=1&pageSize=60
- taobaoUrl: https://s.taobao.com/search?q={产品名称}
- 产品名称需要URL编码（使用encodeURIComponent）`;
